...
class submitOrder():   
    ...
    def test_web_submitOrder(self):
        submiturl = getConstant.IP_WEB_91+'/publicworkstation/complaint/saveComplaint.action'
        m = MultipartEncoder(
            fields = {
    ...
    def test_app_EnterInspection(self):
        ...
        zfjxjsb_url = getConstant.IP_WEB_91+"/dcmsmobile/PwasAdmin/Patrol-pdalist.action?userId="+self.orderData['id']+"&page.pageSize=3&page.pageNo=1"
    ...
    #         print("555555555555555555555555",xjlx_result)
    ...
    #             "fieldintro":self.zfjUser['fieldintro'],
    #             "gridid":self.zfjUser['gridid'],
    #             "bgadminid.id":self.zfjUser['id'],
    #             "description":self.zfjUser['description'],
    #             "mposl":self.zfjUser['mposl'],
    #             "username":self.zfjUser['name'],
    #             "mposb":self.zfjUser['mposb']
    #         }
