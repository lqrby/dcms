...
class MyTest(unittest.TestCase):     #封装测试环境的初始化和还原的类  
    ...
    #调整批示    
    def test_08tiaoZhengPiShi(self):
        time.sleep(random.randint(1,2)) 
        dataItem = {}
