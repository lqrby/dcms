...
class readExcel():
    ...
    def readData(self,i):
        ...
        personData[ws["M" + str(j)].value] = ws["M" + str(self.i)].value
        personData[ws["N" + str(j)].value] = ws["N" + str(self.i)].value
        # print(personData)
...
if __name__ == "__main__":
    filename = 'E:/test/dcms/ChengGuan/testFile/newPersonnel/zx_login_180.xlsx'
