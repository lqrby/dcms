...
class allLogin():
    ...
    def test_web_login(self):  #登录的方法
        loginResult = False
        authCode = test_login_authCode(self.driver) #获取验证码
        while authCode == "" :
            authCode = test_login_authCode(self.driver) 
        else:
...
if __name__=="__main__":
    ...
    userData_null = {}
    # userData['sm']['loginName'] = '13161577834'
    # userData['sm']['password'] = '111111'

    # userData['wggly']['role'] = '2'
    # userData['wggly']['logonname'] = 'glyld'
    # userData['wggly']['logonpassword'] = '111111'

    # userData['qsdw']['role'] = '6'
    # userData['qsdw']['logonname'] = 'hbj'
    # userData['qsdw']['logonpassword'] = '111111'

    # userData['zfj']['role'] = '5'
    # userData['zfj']['logonname'] = 'zfj'
    # userData['zfj']['logonpassword'] = '111111'
    login = allLogin(driver,userData)
    login.test_web_login()
    login.test_app_allLogin()
    # allLogin(driver,userData).test_app_sm_login()
