...
# pytesseract.pytesseract.tesseract_cmd = 'D:/python\Lib/site-packages/Tesseract-OCR/tesseract.exe'
...
def main():
    ...
    # 识别指定文件目录下的图片
    # 图片存放目录figures
    # dir = 'E:/test/dcms/ChengGuan/com/img/yzm.jpg'
    ...
    # 单张图片识别
    image_path = 'E:/test/dcms/ChengGuan/com/img/yzm12.png'
    imgResult = OCR_lmj(image_path)
